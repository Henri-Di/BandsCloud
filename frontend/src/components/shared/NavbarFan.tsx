...
const Navbar: React.FC = () => {
  ...
  // Menu items com label, link e ícone ajustados
  const menuItems = [
    { label: "Dashboard", href: "/artist", icon: <FiHome /> },            // correto
    { label: "Perfil", href: "#perfil", icon: <FiUser /> },              // correto
    { label: "Artistas", href: "#artistas", icon: <FiUsers /> },         // trocado de FiMusic para FiUsers (artistas = pessoas)
    { label: "Álbuns", href: "#albuns", icon: <FiFolder /> },           // correto
    { label: "Playlists", href: "#playlists", icon: <FiMusic /> },       // trocado de FiCalendar para FiMusic (playlists = música)
    { label: "Eventos e Shows", href: "#eventos", icon: <FiCalendar /> },        // adicionado item "Eventos" com calendário (antes "Playlists")
    { label: "Seguidores", href: "#seguidores", icon: <FiUser /> },      // trocado para FiUser (seguidores são usuários)
