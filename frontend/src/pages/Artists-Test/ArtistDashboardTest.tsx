...
<ProfileSettingsCard
  ...
  email="bandscloud.artista@example.com"
  bio="Cantor e compositor de indie pop apaixonado por novas sonoridades. Em busca de oportunidades e colaborações criativas."
  avatarUrl="" 
